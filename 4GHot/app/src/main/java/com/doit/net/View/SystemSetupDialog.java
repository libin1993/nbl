...
public class SystemSetupDialog extends Dialog {
    ...
    private LteChannelCfg lteChannelCfg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lteChannelCfg = CacheManager.channels.get(0);

        gps.setText(lteChannelCfg.getGpsOffset());
        pci.setText(lteChannelCfg.getPci());
...
//                    sync.equals(CacheManager.getCellConfig().getSync())?"":sync);
            ...
            ProtocolManager.setChannel(lteChannelCfg.getIp(),null,null,null,null,null,tddPci);
