...
public final class LTEMsgCode {
    ...
    public final static class SendCode {
        ...
        public static final String REBOOT = "06";  //重启设备
        ...
        public static final String SET_BLACKLIST = "10";  //设置黑名单
        public static final String SET_UPGRADE = "11"; //设备升级
        ...
        public static final String SET_SYNC_PARAM = "16";  //GSP同步、空口同步
        public static final String SET_TIME = "17";  //同步时间
        public static final String GET_CUSTOM_PA_PARAM = "18";
        public static final String SET_FALLBACK = "19";   //版本回退
